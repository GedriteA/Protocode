 ...
 */
public class MyAboutObjectProvider {
    public MyAboutObjectProvider(Context context) {
    ...
    public ArrayList<MyObject> getObjects(){
        ...
        for(int i=1;i<=2;i++){
            ...
            myObject.setImageId(context.getResources().getIdentifier("b".concat(String.valueOf(i)),"drawable",context.getPackageName()));
